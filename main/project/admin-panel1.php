...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> Mediplus </a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="http://localhost/main/project/bbankreg.php">Add Blood Banks</a>
      <a class="list-group-item list-group-item-action" href="http://localhost/project/eccomerece.php">Add Products</a>
      ...
      <div class="tab-pane fade show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
               ...
               <div class="col-sm-4" style="margin: 0 auto; margin-top: 5%; padding-left: 400px;">
   <div class="panel panel-white no-radius text-center">
       <div class="panel-body">
           ...
           <h4 class="StepTitle" style="margin-top: 5%;">Blood Bank</h4>
           <p class="cl-effect-1">
               <a href="http://localhost/project/bbankreg.php" onclick="clickDiv('#list-adoc-list')">Add Blood Banks</a>
           </p>
       </div>
   </div>
</div>
